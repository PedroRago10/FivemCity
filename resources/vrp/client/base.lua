...
AddStateBagChangeHandler("SetDiscord",nil,function(Name,Key,Value)
	...
	SetDiscordRichPresenceAssetText("011RP Sao Paulo")
	SetDiscordRichPresenceAssetSmall("developer")
	SetDiscordRichPresenceAssetSmallText("Equipe 011RP")
	SetDiscordRichPresenceAction(0,"Jogar","fivem://connect/cfx.re/join/SEUCODE")
	SetDiscordRichPresenceAction(1,"Social","https://discord.gg/SEU_LINK")
