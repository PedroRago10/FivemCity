...
function vRP.ServiceEnter(Source, Passport, Permission, Silenced)
    print("DEBUG: ServiceEnter called for " .. tostring(Permission) .. " Source: " .. tostring(Source))
    if Characters[Source] then
        ...
        print("DEBUG: ServiceEnter - Set State " .. tostring(Permission) .. " to true. Current Value: " .. tostring(Player(Source)["state"][Permission]))
	...
	local function Connect(name,setKickReason,deferrals)
		...
		CreateThread(function()
			...
			while true do
				...
				local message = string.format("011RP Sao Paulo \n\n"..Lang.Position.."%s\nEvite punicoes, fique por dentro das regras de conduta.\nAtualizacoes frequentes, deixe sua sugestao em nosso discord.",pos,#Queue.QueueList,dots)
